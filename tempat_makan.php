...
<tr>
  ...
  <table width="1358" border="0" align="left">
    <tr style="text-align: center">
      <td width="75%" bgcolor="#0b6572" class="footer" style="font-style: normal; color: #FFF; font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; font-weight: bolder;">Daftar Tempat Makan</td>
    </tr>
    <tr>
...
while ($hasil = mysql_fetch_array ($sql)){
 $nama_restoran = stripslashes ($hasil['Nama']);
 $alamat_restoran = stripslashes ($hasil['Alamat']);
 $notelp_restoran = stripslashes ($hasil['NoTelp']);
 $email_restoran = stripslashes ($hasil['Email']);
 //tampilkan berita
 echo "<br>Nama        : ".$nama_restoran."<br>";
 echo "Alamat        : ".$alamat_restoran."<br>";
 echo "No Telp        : ".$notelp_restoran."<br>";
 echo "Email        : ".$email_restoran."<br>";
}
?>
      &nbsp;</p></td>
    </tr>
