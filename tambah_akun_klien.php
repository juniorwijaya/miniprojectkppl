...
<tr>
  ...
  <table width="1358" border="0" align="left">
    <tr style="text-align: center">
      <td width="75%" bgcolor="#0b6572" class="footer" style="font-style: normal; color: #FFF; font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; font-weight: bolder;">Tambah Akun Klien</td>
    </tr>
    ...
    <tr>
	  ...
	  <form action="" method="post" name="input" id="input">
        ...
        <p>
          ...
          <input name="nohp" type="text" required="required" id="nohp" />
        </p>
        <p>
...
if (isset($_POST['submit2'])) {
 ...
 $nohp = addslashes (strip_tags ($_POST['nohp'])); 
 $email = addslashes (strip_tags ($_POST['email']));  
 
 //insert ke tabel 
 $query ="INSERT INTO `klien`(`Nama`, `Alamat`, `NoHP`, `Email`) VALUES ('".$nama."','".$alamat."','".$nohp."','".$email."')"; 
 $sql = mysql_query ($query); 
 if ($sql) { 
 echo "<h2><font color=blue>Pendaftaran Klien Berhasil</font></h2>"; 
 } else { 
