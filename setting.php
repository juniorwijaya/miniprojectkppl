...
<tr>
  ...
  <table width="1358" border="0" align="left">
    <tr style="text-align: center">
      <td width="75%" bgcolor="#0b6572" class="footer" style="font-style: normal; color: #FFF; font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; font-weight: bolder;">Setting</td>
    </tr>
    <tr>
